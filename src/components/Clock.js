  ...
  render() {
    ...
    return (
      <div className={`clock ${color}`}>
        <svg width="40" height="40" viewBox="0 0 60 66.145" xmlns="http://www.w3.org/2000/svg"><g transform="translate(-15.875 -32.417)"><ellipse className="fill0" cx="46.302" cy="37.708" rx="9.26" ry="5.292" fill="#41af8e" /><ellipse className="fill1" cx="46.302" cy="37.708" rx="7.938" ry="3.969" fill="#a4eac5" /><circle className="fill0" cx="45.875" cy="68.562" r="30" fill="#41af8e" /><circle className="fill1" cx="45.963" cy="68.475" r="28.5" fill="#a4eac5" /><circle className="fill0" cx="46.225" cy="68.477" r="24" fill="#41af8e" /><circle cx="46.313" cy="68.39" r="22.5" fill="#fff" /><g className="fill0" fill="#41af8e"><circle cx="46.302" cy="49.615" r="1.323" /><circle cx="27.781" cy="68.135" r="1.323" /><circle cx="64.823" cy="68.135" r="1.323" /><circle cx="46.302" cy="86.656" r="1.323" /></g><g className="fill0" fill="#41af8e"><circle cx="46.302" cy="68.135" r="1.323" /><ellipse ref={this.minHand} cx="54.302" cy="68.135" rx="7.938" ry="1.323" /><ellipse ref={this.hrHand} cx="46.302" cy="75.135" rx="1.323" ry="6.482" /></g></g></svg>
        <div>
